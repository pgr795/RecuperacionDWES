...
<body>
	...
	<form method="post" action="RealizarSorteo_controllers.php">
			...
			<div>
			<input type='submit' name='accion' value='Generar combinacion ganadora' class="btn btn-warning disabled"/>
			<?php
			...
			<br><br>
			<div>
				<input type='submit' name='accion' value='Realizar Sorteo' class="btn btn-warning disabled"/>
