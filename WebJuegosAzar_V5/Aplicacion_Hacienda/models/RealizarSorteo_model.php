...
function actualizarSaldos($conexion,$SorteoActivo,$idUsuario){
	try{
		$premios=totalPremiosGanados($conexion,$SorteoActivo,$idUsuario);
		$saldo=saldoApostante($conexion,$SorteoActivo,$idUsuario);
...
////////////////////////////////////////////////////////////////////////////////////////////////
function totalPremiosGanados($conexion,$SorteoActivo,$idUsuario){
	try{
...
function saldoApostante($conexion,$SorteoActivo,$idUsuario){
	try{
