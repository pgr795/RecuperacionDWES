...
<body>
	...
	<form method="post" action="RealizarApuesta_controllers.php">
			...
			<div>
				...
				<input type='submit' name='accion' value='Realizar Apuestas' class="btn btn-warning disabled"/>
				<input type='submit' name='accion' value='Borrar Apuestas' class="btn btn-warning disabled"/>
