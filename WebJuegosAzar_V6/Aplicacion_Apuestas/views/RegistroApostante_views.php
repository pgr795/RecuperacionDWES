...
<body>
	...
	<form method="post" action="../pasarela/ejemploGeneraPet2.php">
			...
			<p>Saldo: <input type='number' name="saldo" min="1" value="1">*Para poner decimales Ej: 14.50 </p>
			<input type='submit' name='accion' value='Registro Apostante' class="btn btn-warning disabled"/>
